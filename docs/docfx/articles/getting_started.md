...
YARP 1.0.0 Preview 2 supports ASP.NET Core 3.1 and 5.0.0 Preview 6 or later. You can download the .NET 5 Preview SDK from https://dotnet.microsoft.com/download/dotnet/5.0. It requires Visual Studio 2019 (v16.6) or newer.
...
And then add:
 ...
 ```
<ItemGroup> 
  <PackageReference Include="Microsoft.ReverseProxy" Version="1.0.0-preview.2.*" /> 
</ItemGroup> 
```
