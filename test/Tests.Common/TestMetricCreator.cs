// <copyright file="TestMetricCreator.cs" company="Microsoft Corporation">
...
namespace Tests.Common
{
    ...
    public class TestMetricCreator : IMetricCreator
    {
        ...
        {
            var slowLogger = this.Create(metricName, new string[0]);
        ...
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName });
        ...
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName1, dimensionName2 });
        ...
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName1, dimensionName2, dimensionName3 });
        ...
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName1, dimensionName2, dimensionName3, dimensionName4 });
        ...
        {
            var slowLogger = this.Create(metricName, new[] { dimensionName1, dimensionName2, dimensionName3, dimensionName4, dimensionName5 });
