...
namespace Yarp.ReverseProxy.ServiceFabric
{
    internal sealed class CachedServiceFabricCaller : ICachedServiceFabricCaller
    {
        ...
        private readonly Cache<IEnumerable<PartitionWrapper>> _partitionListCache;
            ...
            IHealthClientWrapper healthClientWrapper)
        {
            ...
            _partitionListCache = new Cache<IEnumerable<PartitionWrapper>>(_clock, CacheExpirationOffset);
        ...
        public async Task<IEnumerable<PartitionWrapper>> GetPartitionListAsync(Uri serviceName, CancellationToken cancellation)
        {
            return await TryWithCacheFallbackAsync(
