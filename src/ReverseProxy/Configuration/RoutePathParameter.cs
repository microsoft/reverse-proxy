...
/// <summary>
/// Route criteria for a path parameter that must be present on the incoming request.
/// </summary>
public sealed record RoutePathParameter
{
    /// <summary>
    ...
    /// <summary>
    /// A collection of acceptable path parameter values used during routing.
    /// </summary>
    ...
    public bool Equals(RoutePathParameter? other)
    {
        if (other == null)
        {
            return false;
