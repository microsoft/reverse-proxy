...
namespace Microsoft.ReverseProxy.Service
{
    ...
    internal interface IRuntimeRouteBuilder
    {
        ...
        /// </param>
        /// <param name="clusterOrNull">Cluster that this route maps to.</param>
        ...
        /// <paramref name="source"/> and <paramref name="clusterOrNull"/>.
        /// </param>
        RouteConfig Build(ParsedRoute source, ClusterInfo clusterOrNull, RouteInfo runtimeRoute);
