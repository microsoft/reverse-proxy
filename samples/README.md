...
| [Minimal](ReverseProxy.Minimal.Sample) | Shows a minimal config-based YARP application using [Minimal Hosting for ASP.NET Core](https://github.com/dotnet/aspnetcore/issues/30354) |
